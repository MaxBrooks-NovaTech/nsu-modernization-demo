...
6. Consume GEMINI review findings.
...
3. Fix failures.
4. Validate outputs.
5. Update implementation-status-gemini.md.
6. Update codex-handoff.md.
7. Hand off to GEMINI.

Continue autonomously unless a stop condition occurs.

---

## 6. GEMINI REVIEW LOOP
...
6. Update implementation-status-gemini.md.
7. Update codex-handoff.md.
8. Return control to GEMINI.
