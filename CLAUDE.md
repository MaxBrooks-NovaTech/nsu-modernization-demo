...
Defines WHAT Claude previously found.

### Detailed Claude review criteria
...
3. Current implementation-status.md.
4. Current Codex handoff.
5. Current Claude review.
...
Claude may return actionable P0/P1 findings to Codex without waiting for
...
3. Read claude-review.md if it exists.
...
Until that gate is reached, Claude may participate in the autonomous
Codex → Claude → Codex loop.
...
Claude may directly recommend or make small corrections for:
...
Use the template defined in CLAUDE_REVIEW_SPEC.md.
...
"Claude review complete. Waiting for human authorization."
